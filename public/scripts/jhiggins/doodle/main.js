...
function init() {
    ...
    function gameOver() {
        ...
        if(player.y > height/2 && flag === 0) {
            ...
            facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://striderfly.xx/jhiggins/doodle&p[title]=I just scored ' +score+ ' points in the HTML5 Doodle Jump game!&p[summary]=Can you beat me in this awesome recreation of Doodle Jump created in HTML5?';
